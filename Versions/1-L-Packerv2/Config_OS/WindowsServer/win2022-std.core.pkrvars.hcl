...
vm_name                 = "WSRV2022STDCORE-PCK"
operating_system_vm     = "windows2019srvNext_64Guest" # windows2022srvNext_64Guest Microsoft Windows Server 2025 (64-bit)
vm_cdrom_type           = "sata"
vm_cpus                 = "2"
vm_cores                = "2"
