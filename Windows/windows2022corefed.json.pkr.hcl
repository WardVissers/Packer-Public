...
source "vsphere-iso" "autogenerated_1" {
  ...
  floppy_files         = ["setup/win22corefed/efi/autounattend.xml","setup/begin.ps1","setup/install-vmtools.ps1","setup/enable-winrm.ps1","setup/Server_ChangeCDRomDriveLetter.ps1","setup/Server_Disable_IPv6_NetBios.ps1","setup/Server_Print_Spooler_Disable.ps1","setup/featuresondemand.ps1","setup/disable-autolog.ps1"]
...
build {
  ...
  provisioner "powershell" {
   ...
   provisioner "powershell" {
    ...
    script   = "./setup/featuresondemand.ps1"
  }
